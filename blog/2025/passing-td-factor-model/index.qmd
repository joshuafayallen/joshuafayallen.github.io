...
sysfonts::font_add(
  'Assistant',
  regular = 'Assistant/Assistant-Regular.ttf'
)
...
idata = az.from_netcdf('postpreds.nc')
...
idata = idata.assign_coords(mindex_coords)
...
posterior_predictive = open_dataset('post-preds-subset') |>
  collect() 
...
just_amon_ra = cumulative_stats_pd[cumulative_stats_pd['receiver_full_name'] == player]
amon_ra_coords = xr.Coordinates.from_pandas_multiindex(
    just_amon_ra.set_index(
        [
            "receiver_full_name",
            "number_of_seasons_played",
            "games_played",
...
player_probs_post = xr.open_dataarray('amon-ra-probs.nc').assign_coords(amon_ra_coords)
